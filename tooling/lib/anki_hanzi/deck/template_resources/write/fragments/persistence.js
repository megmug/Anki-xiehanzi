  ...
  if (void 0 === window.Persistence) {
    var e = "github.com/SimonLammer/anki-persistence/",
      t = "_default";
    if (
      ((window.Persistence_localStorage = function () {
        var i = !1;
        try {
          null !== window.localStorage &&
            ...
            (this.clear = function () {
              for (var t = 0; t < localStorage.length; t++) {
                ...
                0 == i.indexOf(e) && (localStorage.removeItem(i), t--);
              }
            }),
            (this.setItem = function (i, n) {
              (void 0 == n && ((n = i), (i = t)),
                localStorage.setItem(e + i, JSON.stringify(n)));
            }),
            (this.getItem = function (i) {
              return (
                void 0 == i && (i = t),
                JSON.parse(localStorage.getItem(e + i))
              );
            }),
            (this.removeItem = function (i) {
              (void 0 == i && (i = t), localStorage.removeItem(e + i));
            }));
        } catch (n) {}
      ...
      (window.Persistence_windowKey = function (i) {
        ...
        ("object" == typeof n &&
          ...
          (this.setItem = function (i, o) {
            (void 0 == o && ((o = i), (i = t)), (n[e][i] = o));
          }),
          (this.getItem = function (i) {
      ...
      navigator.userAgent.indexOf("Mobile") > 0 &&
        ((window.Persistence = new Persistence_localStorage()),
